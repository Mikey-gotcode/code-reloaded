...
<body>
    <div class="welcome-section">
        <img src="patient_image.jpg" alt="patient's image">
        ...
        <div class="user-info">
            ...
            <table>
                ...
                <tr>
                    ...
                    <td><?php echo $_SESSION['Date-of-birth'];?></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td><label>Date_registered:</label></td>
                    <td><?php echo $_SESSION['Date_registered'];?></td>
                </tr>
                <tr>
                    <td><a href="edit_patient.php" class="btn">EDIT</a></td>
                </tr>
            </table>
        </div>
    </div>
